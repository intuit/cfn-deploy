# Contributing to cfn-deploy

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to [cfn-deploy](https://github.com/intuit/cfn-deploy). These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
* [Join the cfn-deploy Gitter Channels](https://gitter.im/cfn-deploy)
    * Use the `#general` channel for general questions or discussion about cfn-deploy
...
This section guides you through submitting a bug report for cfn-deploy. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behavior :computer: :computer:, and find related reports :mag_right:.
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps or point out the part of cfn-deploy which the suggestion is related to. You can use [this tool](http://www.cockos.com/licecap/) to record GIFs on macOS and Windows, and [this tool](https://github.com/colinkeenan/silentcast) or [this tool](https://github.com/GNOME/byzanz) on Linux.
* **Explain why this enhancement would be useful** to cfn-deploy users.
* **List some other tools or applications where this enhancement exists.**
* **Specify which version of cfn-deploy you're using.**
